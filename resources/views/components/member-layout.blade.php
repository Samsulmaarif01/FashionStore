    ...
    <div class="flex flex-1">
            ...
            <nav class="flex-1 p-4 space-y-1">
                @php
                    $navItems = [
                        ...
                        ['label' => 'Kotak Masuk', 'route' => 'member.inbox', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4" />'],
        ...
        <main class="flex-1 p-6 md:p-10 overflow-auto">
            ...
            <div class="md:hidden flex gap-2 mb-6 overflow-x-auto pb-2">
                ...
                <a href="{{ route('member.inbox') }}"
                    class="flex-shrink-0 px-4 py-2 text-xs font-bold uppercase tracking-wider border {{ request()->routeIs('member.inbox') ? 'bg-black text-white border-black' : 'border-gray-200 text-gray-600 hover:border-black' }} transition-colors">
                    Kotak Masuk
                </a>
