                            ...
                            <tr class="hover:bg-gray-50 transition-colors">
                                ...
                                <td class="px-5 py-4">
                                    <form method="POST" action="{{ route('admin.orders.status', $order) }}" class="flex items-center gap-2">
                                        @csrf
                                        @method('PATCH')
                                        <select name="status" class="px-2 py-1.5 border border-gray-200 text-xs bg-white focus:outline-none focus:border-indigo-500 transition-colors rounded-lg">
                                        ...
                                        <button type="submit" class="px-2 py-1.5 bg-black text-white text-[10px] font-bold uppercase tracking-wider hover:bg-indigo-600 transition-colors rounded-lg">
                                            OK
                                        </button>
                                    </form>
                                </td>
