                    ...
                    <div class="mt-4">
                        ...
                        <div class="grid grid-cols-2 gap-3 mt-3" x-show="discount > 0" x-cloak>
                            <div>
                                ...
                                <input type="date" name="discount_start" id="discount_start" value="{{ old('discount_start', $product->discount_start?->format('Y-m-d')) }}"
                            ...
                            <div>
                                ...
                                <input type="date" name="discount_end" id="discount_end" value="{{ old('discount_end', $product->discount_end?->format('Y-m-d')) }}"
                                    class="w-full px-3 py-2 border border-gray-200 bg-gray-50 text-xs focus:outline-none focus:border-blue-500 transition-colors">
                            </div>
                        </div>
