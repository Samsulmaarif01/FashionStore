<x-member-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm border border-gray-100 p-6 rounded-2xl">
                <div class="mb-8">
                ...
                @if($wishlists->isEmpty())
                    <div class="text-center py-20 bg-gray-50 border border-dashed border-gray-200 rounded-2xl">
                        ...
                        <a href="{{ route('collection') }}" class="inline-block bg-black text-white px-8 py-3 text-[10px] font-black uppercase tracking-widest hover:bg-blue-600 transition-all rounded-xl">
                            Mulai Belanja
                        </a>
                    </div>
                @else
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        @foreach($wishlists as $wishlist)
                            ...
                            <div class="group relative bg-white border border-gray-100 transition-all hover:shadow-xl rounded-2xl overflow-hidden">
                                <div class="relative aspect-square overflow-hidden bg-gray-50">
                                    ...
                                    <form action="{{ route('member.wishlist.toggle', $product) }}" method="POST" class="absolute top-3 right-3 z-20">
                                        @csrf
                                        <button type="submit" class="p-2 bg-white text-red-500 shadow-md hover:bg-red-50 transition-colors rounded-full">
