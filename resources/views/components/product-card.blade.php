...
<div class="product-card group relative bg-white flex flex-col overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-1">
    ...
    <div class="relative w-full aspect-[4/5] bg-gray-100 overflow-hidden">
        ...
        <div class="absolute bottom-0 left-0 right-0 p-4 translate-y-full opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-in-out z-20">
            <button class="w-full bg-white text-black py-3 font-semibold text-sm hover:bg-black hover:text-white transition-colors duration-300 shadow-lg">
                Tambah ke Keranjang
            </button>
        </div>
    </div>
    ...
    <div class="p-6 flex flex-col flex-1">
        ...
        <a href="#" class="text-lg font-bold text-gray-900 group-hover:text-indigo-600 transition-colors duration-300">
            {{ $product['name'] }}
        </a>
        <div class="mt-auto pt-4 flex items-center justify-between">
            ...
            <!-- Quick View Icon -->
            <button class="text-gray-400 hover:text-indigo-600 transition-colors duration-300">
